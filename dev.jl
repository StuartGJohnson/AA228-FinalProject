...
serialize("pomdp_2cp_30.jls", pomdp)
...
report_file = "sarsop_report_2cp_30.txt"
...
mv("policy.out", "policy_2cp_30.out", force=true)

for j in 1:5
    Random.seed!(j)
    sim = GifSimulator(filename="test_2cp_30$j.gif", max_steps=100)
